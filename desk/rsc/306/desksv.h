...
/* [1][ P† denna diskett finns | %L byte tillg„ngliga | f”r anv„ndning. ][ FORTSŽTT | AVSLUTA ] */
...
/* [1][%S ej funnen.|Vill du ta bort ikonen|eller v„lja objekt?][TA BORT|VŽLJ|AVBRYT] */
