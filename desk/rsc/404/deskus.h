...
#define TEXTLINES         14 /* form/dialog */
...
#define MPSKIP            17 /* BUTTON in tree MNINSAPP */
#define MPCANCEL          18 /* BUTTON in tree MNINSAPP */

#define MNSETPREF         22 /* form/dialog */
#define SPDTITLE           3 /* TEXT in tree MNSETPREF */ /* max len 14 */
#define SPDBUTTN           4 /* BUTTON in tree MNSETPREF */
#define SPCTITLE           5 /* TEXT in tree MNSETPREF */ /* max len 13 */
#define SPCBUTTN           6 /* BUTTON in tree MNSETPREF */
#define SPOTITLE           7 /* TEXT in tree MNSETPREF */ /* max len 17 */
#define SPOBUTTN           8 /* BUTTON in tree MNSETPREF */
#define MNSPOK             9 /* BUTTON in tree MNSETPREF */
#define MNSPCAN           10 /* BUTTON in tree MNSETPREF */
...
#define READERROR          8 /* Free string */
/* -File read error- */
...
#define NCONFLICT         13 /* Free string */
/* NAME CONFLICT! */
...
#define STFOEXISTS        70 /* Alert string */
...
#define STDISKFULL        71 /* Alert string */
...
#define STBADCOPY         73 /* Alert string */
