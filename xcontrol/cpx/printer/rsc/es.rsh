...
TEDINFO rs_tedinfo[] = {
	...
	{ (BYTE *)17L, (BYTE *)18L, (BYTE *)19L, 3, 6, 2, 0x1180, 0x0, -1, 8,1 },
...
OBJECT rs_object[] = {
	...
	{ 16, 2, 14, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0000, 0x0515,0x000b },
	...
	{ 5, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x7L), 0x0500,0x0900, 0x0006,0x0001 },
	...
	{ 14, 12, 13, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0906, 0x0515,0x0202 },
	...
	{ 1, 15, 15, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0c08, 0x030a,0x0402 },
	{ 14, -1, -1, G_BUTTON, 0x45, OS_NORMAL, C_UNION(0x10L), 0x0101,0x0a00, 0x0008,0x0001 },
	{ 19, 17, 18, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0615,0x0000, 0x020a,0x0504 },
	{ 18, -1, -1, G_BOXTEXT, OF_TOUCHEXIT, OS_SHADOWED, C_UNION(0x4L), 0x0700,0x0302, 0x0308,0x0301 },
	{ 16, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x14L), 0x0102,0x0900, 0x0006,0x0001 },
	{ 22, 20, 21, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0615,0x0604, 0x020a,0x0604 },
	{ 21, -1, -1, G_BOXTEXT, OF_TOUCHEXIT, OS_SHADOWED, C_UNION(0x5L), 0x0700,0x0302, 0x0308,0x0401 },
	{ 19, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x18L), 0x0402,0x0a00, 0x0205,0x0001 },
	{ 0, 23, 24, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x040a,0x0c08, 0x0415,0x0402 },
	{ 24, -1, -1, G_BUTTON, 0x7, OS_NORMAL, C_UNION(0x19L), 0x0001,0x0a00, 0x020a,0x0001 },
	{ 22, -1, -1, G_BUTTON, 0x25, OS_NORMAL, C_UNION(0x1AL), 0x050c,0x0a00, 0x0008,0x0001 }
};
