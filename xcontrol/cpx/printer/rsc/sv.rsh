...
TEDINFO rs_tedinfo[] = {
	...
	{ (BYTE *)23L, (BYTE *)24L, (BYTE *)25L, 3, 6, 2, 0x1180, 0x0, -1, 5,1 }
};
...
OBJECT rs_object[] = {
	...
	{ 19, 18, 18, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0c08, 0x030a,0x0402 },
	{ 17, -1, -1, G_BUTTON, 0x45, OS_NORMAL, C_UNION(0x14L), 0x0101,0x0a00, 0x0008,0x0001 },
	{ 22, 20, 21, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x040a,0x0c08, 0x0415,0x0402 },
	{ 21, -1, -1, G_BUTTON, 0x7, OS_NORMAL, C_UNION(0x15L), 0x0501,0x0a00, 0x0008,0x0001 },
	{ 19, -1, -1, G_BUTTON, 0x5, OS_NORMAL, C_UNION(0x16L), 0x000c,0x0a00, 0x0008,0x0001 },
	{ 0, 23, 24, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0615,0x0604, 0x020a,0x0504 },
	{ 24, -1, -1, G_BOXTEXT, OF_TOUCHEXIT, OS_SHADOWED, C_UNION(0x5L), 0x0700,0x0402, 0x0308,0x0301 },
	{ 22, -1, -1, G_STRING, OF_LASTOB, OS_NORMAL, C_UNION(0x1AL), 0x0701,0x0900, 0x0406,0x0301 }
};
