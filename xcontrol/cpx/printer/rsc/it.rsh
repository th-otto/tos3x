...
TEDINFO rs_tedinfo[] = {
	...
	{ (BYTE *)8L, (BYTE *)9L, (BYTE *)10L, 3, 6, 2, 0x1180, 0x0, -1, 6,1 },
	{ (BYTE *)12L, (BYTE *)13L, (BYTE *)14L, 3, 6, 2, 0x1180, 0x0, -1, 5,1 },
...
OBJECT rs_object[] = {
	...
	{ 14, 2, 11, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0000, 0x0515,0x0d08 },
	...
	{ 5, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x7L), 0x0500,0x0900, 0x0007,0x0001 },
	...
	{ 8, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0xBL), 0x0500,0x0900, 0x0008,0x0001 },
	{ 1, 12, 13, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0906, 0x0515,0x0402 },
	{ 13, -1, -1, G_BOXTEXT, OF_TOUCHEXIT, OS_SHADOWED, C_UNION(0x3L), 0x010d,0x0900, 0x0207,0x0101 },
	{ 11, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0xFL), 0x0500,0x0a00, 0x000c,0x0001 },
	...
	{ 14, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x13L), 0x0502,0x0900, 0x0005,0x0001 },
	{ 20, 18, 19, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0615,0x0604, 0x020a,0x0804 },
	{ 19, -1, -1, G_BOXTEXT, OF_TOUCHEXIT, OS_SHADOWED, C_UNION(0x5L), 0x0700,0x0602, 0x0308,0x0301 },
	{ 17, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x17L), 0x0701,0x0b00, 0x0306,0x0201 },
	{ 22, 21, 21, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0e08, 0x020a,0x0202 },
	{ 20, -1, -1, G_BUTTON, 0x45, OS_NORMAL, C_UNION(0x18L), 0x0101,0x0900, 0x0008,0x0001 },
	{ 0, 23, 24, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x030a,0x0e08, 0x0515,0x0202 },
	{ 24, -1, -1, G_BUTTON, 0x7, OS_NORMAL, C_UNION(0x19L), 0x0501,0x0900, 0x0008,0x0001 },
	{ 22, -1, -1, G_BUTTON, 0x25, OS_NORMAL, C_UNION(0x1AL), 0x020c,0x0900, 0x0008,0x0001 }
};
