...
#define POK                               21 /* BUTTON in tree PRINTER */
#define PCANCEL                           22 /* BUTTON in tree PRINTER */
#define PSAVE                             24 /* BUTTON in tree PRINTER */
...
#  endif
#endif
extern _WORD de_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD de_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD de_rsc_free(void);
#endif
