...
TEDINFO rs_tedinfo[] = {
	...
	{ (BYTE *)8L, (BYTE *)9L, (BYTE *)10L, 3, 6, 2, 0x1180, 0x0, -2, 13,1 },
...
OBJECT rs_object[] = {
	...
	{ 7, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x3L), 0x0102,0x0000, 0x000d,0x0001 },
	...
	{ 14, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x7L), 0x0502,0x0000, 0x010c,0x0f00 },
	...
	{ 37, -1, -1, G_BUTTON, 0x5, OS_NORMAL, C_UNION(0xBL), 0x0317,0x0400, 0x0008,0x0001 },
	{ 38, -1, -1, G_BUTTON, 0x7, OS_NORMAL, C_UNION(0xCL), 0x070b,0x0500, 0x020a,0x0f00 },
	...
	{ 0, 2, 3, G_BOX, OF_NONE, OS_OUTLINED, C_UNION(0x11100L), 0x0001,0x0101, 0x001e,0x0e08 },
	{ 3, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x1BL), 0x0405,0x0000, 0x0013,0x0001 },
	{ 1, 4, 16, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0100,0x0201, 0x061d,0x0b07 },
	{ 5, -1, -1, G_FTEXT, OF_NONE, OS_NORMAL, C_UNION(0x7L), 0x0616,0x0000, 0x0305,0x0301 },
	{ 6, -1, -1, G_FTEXT, OF_NONE, OS_NORMAL, C_UNION(0x8L), 0x0611,0x0301, 0x000a,0x0001 },
	{ 13, 7, 12, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0600,0x0702, 0x021c,0x0003 },
	{ 8, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x22L), 0x0001,0x0000, 0x000d,0x0001 },
	{ 9, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x23L), 0x0012,0x0000, 0x000a,0x0001 },
	{ 10, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x24L), 0x0001,0x0001, 0x000d,0x0001 },
	{ 11, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x25L), 0x0012,0x0001, 0x000a,0x0001 },
	{ 12, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x26L), 0x0001,0x0002, 0x0010,0x0001 },
	{ 6, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x27L), 0x0012,0x0002, 0x000a,0x0001 },
	{ 14, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x28L), 0x0501,0x0200, 0x000e,0x0001 },
	{ 15, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x29L), 0x0501,0x0301, 0x000a,0x0001 },
	{ 16, -1, -1, G_BUTTON, 0x7, OS_NORMAL, C_UNION(0x2AL), 0x070a,0x0106, 0x0008,0x0001 },
	{ 3, -1, -1, G_FTEXT, 0xA0, OS_NORMAL, C_UNION(0x9L), 0x040b,0x0301, 0x000a,0x0001 }
};
