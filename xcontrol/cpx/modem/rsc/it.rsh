...
OBJECT rs_object[] = {
	{ -1, 1, 21, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0000, 0x0020,0x000b },
	...
	{ 2, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x3L), 0x0400,0x0900, 0x000a,0x0001 },
	...
	{ 5, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x7L), 0x0400,0x0900, 0x0007,0x0001 },
	...
	{ 13, -1, -1, G_BOXTEXT, OF_TOUCHEXIT, OS_SHADOWED, C_UNION(0x3L), 0x000b,0x0800, 0x0708,0x0401 },
	{ 11, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0xFL), 0x0400,0x0a00, 0x000a,0x0001 },
	...
	{ 17, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x13L), 0x0702,0x0300, 0x0205,0x0f00 },
	{ 14, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x14L), 0x0002,0x0301, 0x0007,0x0001 },
	{ 21, 19, 20, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0714,0x0604, 0x010b,0x0704 },
	{ 20, -1, -1, G_BOXTEXT, OF_TOUCHEXIT, OS_SHADOWED, C_UNION(0x5L), 0x0001,0x0802, 0x0009,0x0001 },
	{ 18, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x18L), 0x0001,0x0f00, 0x0009,0x0001 },
	{ 0, 22, 25, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0e08, 0x0020,0x0202 },
	{ 24, 23, 23, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0000, 0x050b,0x0202 },
	{ 22, -1, -1, G_BUTTON, 0x5, OS_NORMAL, C_UNION(0x19L), 0x0601,0x0900, 0x0008,0x0001 },
	{ 25, -1, -1, G_BUTTON, 0x7, OS_NORMAL, C_UNION(0x1AL), 0x000d,0x0900, 0x0607,0x0001 },
	{ 21, -1, -1, G_BUTTON, 0x25, OS_NORMAL, C_UNION(0x1BL), 0x0316,0x0800, 0x0608,0x0101 }
};
