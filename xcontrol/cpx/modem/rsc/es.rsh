...
OBJECT rs_object[] = {
	...
	{ 17, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x13L), 0x0402,0x0300, 0x0006,0x0001 },
	...
	{ 18, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(0x19L), 0x0702,0x0401, 0x0305,0x0201 },
	{ 0, 23, 26, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0e08, 0x0020,0x0202 },
	{ 25, 24, 24, G_BOX, OF_NONE, OS_NORMAL, C_UNION(0xFF1100L), 0x0000,0x0000, 0x040a,0x0202 },
	{ 23, -1, -1, G_BUTTON, 0x5, OS_NORMAL, C_UNION(0x1AL), 0x0201,0x0900, 0x0008,0x0001 },
	{ 26, -1, -1, G_BUTTON, 0x7, OS_NORMAL, C_UNION(0x1BL), 0x050b,0x0900, 0x010a,0x0001 },
	{ 22, -1, -1, G_BUTTON, 0x25, OS_NORMAL, C_UNION(0x1CL), 0x0217,0x0900, 0x0008,0x0001 }
};
