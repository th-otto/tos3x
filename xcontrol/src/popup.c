 ...
 * 02/04/93	cjg	Remove Malloc(), replace with malloc()
 * 06/09/93     cjg     Boy this code is OLD!!!!!
 *			Fixed a problem with the main loop being able
 *			to select the root ( QBASE ).
 */
...
#pragma warn -use
   ...
   if(( obj == -1 ) || ( obj == QBASE ) )	/* cjg 06/09/93 */
      outobj = -1;
   else
