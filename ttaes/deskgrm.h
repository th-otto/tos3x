/*
 * resource set indices for deskgrm
 *
 ...
 * Number of Images:         29
 * Total file size:          27572
 */

#undef RSC_NAME
#define RSC_NAME "deskgrm"
#undef RSC_ID
#ifdef deskgrm
#define RSC_ID deskgrm
#else
#define RSC_ID 0
#endif
...
#define MPITITLE   5 /* TEXT in tree MNINSAPP */ /* max len 14 */
...
#define MPDTITLE  11 /* TEXT in tree MNINSAPP */ /* max len 21 */
#define MPDBUTTN  12 /* BUTTON in tree MNINSAPP */
#define MPPTITLE  13 /* TEXT in tree MNINSAPP */ /* max len 16 */
...
#define SPDTITLE   3 /* TEXT in tree MNSETPRE */ /* max len 15 */
#define SPDBUTTN   4 /* BUTTON in tree MNSETPRE */
#define SPCTITLE   5 /* TEXT in tree MNSETPRE */ /* max len 16 */
#define SPCBUTTN   6 /* BUTTON in tree MNSETPRE */
#define SPOTITLE   7 /* TEXT in tree MNSETPRE */ /* max len 21 */
...
#define SVDTITLE   6 /* TEXT in tree MNSETVID */ /* max len 19 */
...
#define SDTITLE    2 /* TEXT in tree MNSYSTEM */ /* max len 21 */
#define SDBUTTON   3 /* BUTTON in tree MNSYSTEM */
#define SITITLE    4 /* TEXT in tree MNSYSTEM */ /* max len 18 */
...
/* Kann nicht geîffnet werden */

#define NOMEM     10 /* Free string */
/* Nicht genÅgend freier Speicher */
...
/*  %L Bytes benutzt durch %W Objekt. */

#define ISELS     18 /* Free string */
/*  %L Bytes benutzt durch %W angewÑhlte Objekte. */

#define ISEL      19 /* Free string */
/*  %L Bytes benutzt durch %W angewÑhltes Objekt. */

#define ISTRS     20 /* Free string */
/*  %L Bytes benutzt durch %W Objekte. */
...
#  endif
#endif
extern _WORD deskgrm_rsc_load(void);
extern _WORD deskgrm_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD deskgrm_rsc_free(void);
#endif
