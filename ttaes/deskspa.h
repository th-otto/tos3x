/*
 * resource set indices for deskspa
 *
 * created by ORCS 2.14
 */

/*
 * Number of Strings:        553
 * Number of Bitblks:        1
 ...
 * Number of Objects:        475
 * Number of Trees:          27
 * Number of Userblks:       0
 * Number of Images:         29
 * Total file size:          27964
 */

#undef RSC_NAME
#define RSC_NAME "deskspa"
#undef RSC_ID
#ifdef deskspa
#define RSC_ID deskspa
#else
#define RSC_ID 0
#endif
...
#define MPBTITLE   7 /* TEXT in tree MNINSAPP */ /* max len 17 */
#define MPBBUTTN   8 /* BUTTON in tree MNINSAPP */
#define MPFTITLE   9 /* TEXT in tree MNINSAPP */ /* max len 14 */
...
#define SPCTITLE   5 /* TEXT in tree MNSETPRE */ /* max len 17 */
...
#define SVCTITLE   2 /* TEXT in tree MNSETVID */ /* max len 9 */
...
#define SDTITLE    2 /* TEXT in tree MNSYSTEM */ /* max len 13 */
...
/* RENOMBRAR ITEM DESTINO */

#define CRENSTR   15 /* Free string */
/* COPIAR Y RENOMBRAR ITEM(S) */

#define MRENSTR   16 /* Free string */
/* MOVER Y RENOMBRAR ITEM(S) */

#define ISTR      17 /* Free string */
/*  %L bytes usados en %W item. */

#define ISELS     18 /* Free string */
/*  %L bytes usados en %W items seleccionados. */

#define ISEL      19 /* Free string */
/*  %L bytes usados en %W item seleccionado */

#define ISTRS     20 /* Free string */
/*  %L bytes usados en %W items. */

#define DEVICE    21 /* Free string */
/* DISPOSITIVO */

#define SINF      22 /* Free string */
/* Seleccione un Fichero INF */
...
#  endif
#endif
extern _WORD deskspa_rsc_load(void);
extern _WORD deskspa_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD deskspa_rsc_free(void);
#endif
