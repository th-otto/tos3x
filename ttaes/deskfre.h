/*
 * resource set indices for deskfre
 *
 ...
 * Number of Images:         29
 * Total file size:          28018
 */

#undef RSC_NAME
#define RSC_NAME "deskfre"
#undef RSC_ID
#ifdef deskfre
#define RSC_ID deskfre
#else
#define RSC_ID 0
#endif
...
#define MPITITLE   5 /* TEXT in tree MNINSAPP */ /* max len 13 */
#define MPIBUTTN   6 /* BUTTON in tree MNINSAPP */
#define MPBTITLE   7 /* TEXT in tree MNINSAPP */ /* max len 11 */
#define MPBBUTTN   8 /* BUTTON in tree MNINSAPP */
#define MPFTITLE   9 /* TEXT in tree MNINSAPP */ /* max len 18 */
#define MPFBUTTN  10 /* BUTTON in tree MNINSAPP */
#define MPDTITLE  11 /* TEXT in tree MNINSAPP */ /* max len 12 */
...
#define SPCTITLE   5 /* TEXT in tree MNSETPRE */ /* max len 7 */
#define SPCBUTTN   6 /* BUTTON in tree MNSETPRE */
#define SPOTITLE   7 /* TEXT in tree MNSETPRE */ /* max len 14 */
...
#define SVCTITLE   2 /* TEXT in tree MNSETVID */ /* max len 10 */
...
#define SVDTITLE   6 /* TEXT in tree MNSETVID */ /* max len 14 */
...
#define SDTITLE    2 /* TEXT in tree MNSYSTEM */ /* max len 12 */
...
/* RENOMMER FICHIER OBJET */

#define CRENSTR   15 /* Free string */
/* COPIE ET RENOMME OBJET(S) */

#define MRENSTR   16 /* Free string */
/* DEPLACE ET RENOMME OBJET(S) */

#define ISTR      17 /* Free string */
/*  %L octets utilis‚s par %W objet. */

#define ISELS     18 /* Free string */
/*  %L octets utilis‚s par %W objets s‚lectionn‚s. */

#define ISEL      19 /* Free string */
/*  %L octets utilis‚s par %W objet s‚lectionn‚. */

#define ISTRS     20 /* Free string */
/*  %L octets utilis‚s par %W objets. */

#define DEVICE    21 /* Free string */
/* PERIPHERIQUE */

#define SINF      22 /* Free string */
/* Choisir un fichier INF */
...
#  endif
#endif
extern _WORD deskfre_rsc_load(void);
extern _WORD deskfre_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD deskfre_rsc_free(void);
#endif
