/*
 * resource set indices for deskswe
 *
 ...
 * Number of Images:         29
 * Total file size:          27768
 */

#undef RSC_NAME
#define RSC_NAME "deskswe"
#undef RSC_ID
#ifdef deskswe
#define RSC_ID deskswe
#else
#define RSC_ID 0
#endif
...
#define MPITITLE   5 /* TEXT in tree MNINSAPP */ /* max len 16 */
#define MPIBUTTN   6 /* BUTTON in tree MNINSAPP */
#define MPBTITLE   7 /* TEXT in tree MNINSAPP */ /* max len 14 */
#define MPBBUTTN   8 /* BUTTON in tree MNINSAPP */
#define MPFTITLE   9 /* TEXT in tree MNINSAPP */ /* max len 12 */
#define MPFBUTTN  10 /* BUTTON in tree MNINSAPP */
#define MPDTITLE  11 /* TEXT in tree MNINSAPP */ /* max len 17 */
...
#define SPDTITLE   3 /* TEXT in tree MNSETPRE */ /* max len 13 */
...
#define SPOTITLE   7 /* TEXT in tree MNSETPRE */ /* max len 18 */
...
#define SVLTITLE   4 /* TEXT in tree MNSETVID */ /* max len 10 */
#define SVLBUTTN   5 /* BUTTON in tree MNSETVID */
#define SVDTITLE   6 /* TEXT in tree MNSETVID */ /* max len 15 */
...
#define STSVHIGH   5 /* BUTTON in tree MNVIDEO */
...
#define SDTITLE    2 /* TEXT in tree MNSYSTEM */ /* max len 18 */
#define SDBUTTON   3 /* BUTTON in tree MNSYSTEM */
#define SITITLE    4 /* TEXT in tree MNSYSTEM */ /* max len 11 */
...
/*  %L byte anvÑnda i %W objekt. */

#define ISELS     18 /* Free string */
/*  %L byte anvÑnda i %W valda objekt. */

#define ISEL      19 /* Free string */
/*  %L byte anvÑnda i %W valt objekt. */
...
/* [1][ Det gÜr inte att îppna fler | fînster. StÑng ett av de | fînster du inte anvÑnder. ][  OK  ] */

#define STFOEXIS  70 /* Alert string */
/* [2][ Du kan inte skapa en mapp | med det namnet. Fîrsîk IGEN | med ett annat namn eller | vÑlj AVBRYT. ][IGEN| AVBRYT ] */

#define STDISKFU  71 /* Alert string */
/* [1][ PÜ enhet %S: finns det | inte sÜ mycket utrymme | som behîvs. ][  OK  ] */

#define STFO8DEE  72 /* Alert string */
/* [1][ Systemet kan inte skapa | eller nÜ en mapp sÜ lÜngt | upp i katalogtrÑdet. ][  OK  ] */

#define STBADCOP  73 /* Alert string */
/* [1][ Felaktigt fîrfarande! ][  OK  ] */

#define TRSINFO   74 /* Alert string */
/* [1][ %S anvÑnds | fîr att radera filer eller | mappar - fîr alltid!][  OK  ] */

#define FCNOMEM   75 /* Alert string */
/* [3][ Minnet Ñr fullt! ][  OK  ] */

#define FCFAIL    76 /* Alert string */
/* [3][ Ett fel har uppstÜtt under | formatering eller kopiering. | Din diskett kan vara skriv- | skyddad eller obrukbar. | Fîrsîk IGEN eller AVBRYT. ][ IGEN | AVBRYT ] */

#define FCSIZE    77 /* Alert string */
/* [1][ PÜ denna diskett finns | %L byte tillgÑngliga | fîr anvÑndning. ][ FORTSéTT | AVSLUTA ] */

#define FCNOTYPE  78 /* Alert string */
/* [3][ Den diskett du kopierar | till Ñr inte av samma typ | som den du kopierar frÜn.| Byt till en annan diskett | innan du fîrsîker IGEN.][IGEN| AVBRYT ] */

#define SAVETOP   79 /* Alert string */
/* [1][ Vill du spara de | Ñndringar du gjort? ][  OK  | AVBRYT ] */

#define PRINTTOP  80 /* Alert string */
/* [1][ Ska bildskÑrmen skrivas ut? ][  OK  | AVBRYT ] */

#define ABORTCON  81 /* Alert string */
/* [1][ Vill du avbryta? ][ JA | NEJ ] */

#define NOICON    82 /* Alert string */
/* [1][ Det gÜr tyvÑrr inte att | installera fler ikoner. ][  OK  ] */

#define NOAPP     83 /* Alert string */
/* [1][ Det gÜr tyvÑrr inte att | installera fler program. ][  OK  ] */

#define NODRIVE   84 /* Alert string */
/* [1][ Enhet %S: existerar inte. ][ AVBRYT ] */

#define NOOUTPUT  85 /* Alert string */
/* [1][ Din utenhet tar ej emot | data! Fîrsîk IGEN eller | AVBRYT.][ IGEN | AVBRYT ] */

#define CNTOPEN   86 /* Alert string */
/* [1][ Kan ej îppna fil: | %S| HOPPA îver, fîrsîk IGEN | eller AVBRYT.][HOPPA|IGEN| AVBRYT ] */

#define CNTCRTDR  87 /* Alert string */
/* [1][ Kan ej skapa mapp:| %S| HOPPA îver, fîrsîk IGEN | eller AVBRYT. ][HOPPA|IGEN| AVBRYT ] */

#define WRERROR   88 /* Alert string */
/* [1][ Ett fel uppstod vid | kopiering. HOPPA îver | filen eller AVBRYT.][ HOPPA | AVBRYT ] */

#define RDERROR   89 /* Alert string */
/* [1][ Ett fel uppstod vid | lÑsning. HOPPA îver | filen eller AVBRYT.][ HOPPA | AVBRYT ] */

#define CNTCRTFL  90 /* Alert string */
/* [1][ Kan ej skapa fil:| %S| HOPPA îver, fîrsîk IGEN | eller AVBRYT. ][HOPPA|IGEN| AVBRYT ] */

#define CNTDELF   91 /* Alert string */
/* [1][ Kan ej radera fil: | %S| HOPPA îver, fîrsîk IGEN | eller AVBRYT.][HOPPA|IGEN| AVBRYT ] */

#define CNTDELD   92 /* Alert string */
/* [1][ Kan ej radera katalog: | %S| HOPPA îver, fîrsîk IGEN | eller AVBRYT. ][HOPPA|IGEN| AVBRYT ] */

#define PRINTINF  93 /* Alert string */
/* [1][ %S| Ñr en utskriftsenhet. ][  OK  ] */

#define RENAME    94 /* Alert string */
/* [1][ Namnet kunde inte Ñndras! | Fîrsîk IGEN eller AVBRYT. ][ IGEN | AVBRYT ] */

#define NOBUF     95 /* Alert string */
/* [1][Fîr lÜng sîkvÑg ][  OK  ] */

#define DELDISK   96 /* Alert string */
/* [2][ Vill du verkligen radera | alla filer pÜ enhet %S?][ JA | NEJ ] */

#define NOTPRG    97 /* Alert string */
/* [1][ %S| Ñr inte ett program. ][  OK  ] */

#define NOSETDIR  98 /* Alert string */
/* [1][ Misslyckades med att | bestÑmma fîrvald katalog. ][  OK  ] */

#define NOAUTO    99 /* Alert string */
/* [1][ Misslyckades med att | spara AUTO-fil. ][  OK  ] */

#define NOWINMEM 100 /* Alert string */
/* [1][ Misslyckades med att | tilldela fînsterminne. ][  OK  ] */

#define NOTYPE   101 /* Alert string */
/* [1][ OtillÜten filtyp. ][  OK  ] */

#define ICONTYPE 102 /* Alert string */
/* [1][ VÑlj ikontyp. ][SKRIVBORD|FôNSTER|AVBRYT] */

#define NODIRCOP 103 /* Alert string */
/* [1][ OtillÜtet katalogfîrfarande. | HOPPA îver eller AVBRYT. ][ HOPPA | AVBRYT ] */

#define NOINSTAL 104 /* Alert string */
/* [1][ Detta Ñr inte ett | installerbart objekt. ][  OK  ] */

#define NOMORE   105 /* Alert string */
/* [1][ Inga fler filer. ][  OK  ] */

#define NOID     106 /* Alert string */
/* [1][ Ej en enhets-ID. | Fîrsîk IGEN.][  IGEN  ] */

#define ILLMAT   107 /* Alert string */
/* [1][ OtillÜtet .INF-filformat. ][  OK  ] */
...
/* [1][ StÑdning av minnet | misslyckades. ][  OK  ] */

#define FNOTFIND 112 /* Alert string */
/* [1][ %S ej funnen. ][  OK  ] */

#define SNEXT    113 /* Alert string */
/* [1][ Vill du fortsÑtta | sîkningen? ][OK| AVBRYT ] */

#define NOHELP   114 /* Alert string */
/* [1][ HjÑlpmenyn kan ej visas | i denna upplîsning. ][  OK  ] */

#define NOSEA    115 /* Alert string */
/* [1][ Sîkning kan ej utfîras | pÜ en programmodul. ][  OK  ] */

#define KEYUSED  116 /* Alert string */
/* [1][ Tangenten Ñr redan | definierad. Vill du | Ñndra den? ][OK| AVBRYT ] */

#define CARTNOSH 117 /* Alert string */
/* [1][ Kan ej visa info fîr | en programmodul. ][  OK  ] */

#define BADKEY   118 /* Alert string */
/* [1][ OtillÜtet vÑrde pÜ en | funktionstangent. ][  OK  ] */

#define XNFILE   119 /* Alert string */
/* [1][%S ej funnen.|Vill du ta bort ikonen|eller vÑlja objekt?][TA BORT|VéLJ|AVBRYT] */
...
#  endif
#endif
extern _WORD deskswe_rsc_load(void);
extern _WORD deskswe_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD deskswe_rsc_free(void);
#endif
