...
/*************
* MAXFIL5: reduces the maximum number of open files allowed from 16 to 5.
* Note: this includes console files.
* Saves: CPM small 1950, big 1950
*************/
VOID maxfiles5 PROTO((NOTHING));
#ifdef __GNUC__
#define MAXFIL5 maxfiles5();
#else
#define MAXFIL5 maxfiles5;
#endif
...
*************/
#define MINIMAL    	NOFLOAT NOTTYIN NOFILESZ MAXFIL5 NOWILDCARDS NOASCII NOBINARY
