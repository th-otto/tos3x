...
#define AUXIN	 3				/* Auxiliary input	    */
#define AUXOUT	 4				/* Auxiliary output	    */
...
#define R_DSK_SYS	13			/* Reset disk system        */		
#define SEL_DSK	14				/* Select disk		    */
...
#define READ_SEQ	20			/* Read sequential	    */
#define WRT_SEQ	21				/* Write sequential	    */
#define	CREATE	22				/* Create a disk file	    */
#define F_RENAME	23			/* Rename a disk file	    */
#define LOG_VEC	24				/* Return login vector	    */
#define CUR_DSK	25				/* Return current disk	    */
#define	SETDMA	26				/* Set DMA address	    */
#define WRPR_DSK	28			/* Write protect disk	    */
#define RO_VEC	29				/* Return read-only vector  */	
#define FILE_ATR	30			/* Set file attributes	    */
#define DSK_PARM	31			/* Get disk parameters	    */
...
#define RES_DRV 37				/* Reset drive		    */			
#define F_MULTISEC	44			/* Set Multi-Sector Count   */
#define DSK_FREE	46			/* Get disk free space	    */
#define P_CHAIN		47			/* Program Chain	    */
#define FLUSH	48				/* Flush buffers	    */
#define D_BIOS	50				/* Direct bios call	    */
#define PR_LOAD	59				/* Program load function    */
#define	SETVEC	61				/* Set exception vector	    */
#define G_TPA	63				/* Get/Set TPA limits	    */
