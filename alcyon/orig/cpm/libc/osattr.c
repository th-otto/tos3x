...
WORD osattr(NOTHING)
{
	...
	case MPM86V21:						/* MP/M-86 v2.0, v2.1       */
		os_abilities |= /* _os_mtasking | */ _os_0x0004 | _os_oldmultisec | _os_newmultisec | _os_f_parse | _os_filesharing | _os_datetime;
		break;
	...
	case CCPM86V20:					/* CCP/M-86 v2.0        */
		...
		default:						/* Maybe CCP/M-86 v2.0      */
			os_abilities |= /* _os_mtasking | */ _os_0x0004 | _os_oldmultisec | _os_newmultisec | _os_f_parse |
	...
	case CPM86V31:						/* CP/M-86 Plus         */
		os_abilities |= /* _os_mtasking | */ _os_0x0004 | _os_oldmultisec | _os_newmultisec | _os_f_parse | _os_truncates | _os_datetime | _os_fastconio;
		break;
