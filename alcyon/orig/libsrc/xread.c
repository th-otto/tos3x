...
size_t _pc_readblk(P(struct fcbtab *) fcb, P(long) offset, P(VOIDPTR) buff, P(size_t) bytes, P(size_t) secsiz)
...
#endif
	return jread(dosfd, (long) (int) bytes * (long) (int) secsiz, buff);
}
