 ...
 */
int addswitch(P(struct swtch *) sp, P(int) ncases, P(int) nval, P(int) nlab)
...
VOID outforreg(P(int) op, P(struct tnode *) ltp, P(struct tnode *) rtp)
